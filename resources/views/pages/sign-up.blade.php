...
<html lang="en">
  ...
  <body class="bg-img" style="background-image: url('{{asset('assets/images/bg-signup.png')}}'); background-size: 100%;">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
            <form class="p-5 mt-5 form-div mb-5" style="width: 80%; float: right;">
              <div class="form-group">
                <label for="name">First Name</label>
                <input type="text" class="p-4 form-control" id="">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Email address</label>
                <input type="email" class="p-4 form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="password" class="p-4 form-control" id="">
              </div>
