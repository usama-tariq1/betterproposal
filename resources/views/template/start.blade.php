        ...
        <div id="container">
            <div class="navigation">
                <div class="navigate">
                    ...
                    <div class="btn-create-page button-trans  addsection " style="margin-top:40px; display:none;" >Add a Section</div>
                        ...
                        <div class="container">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <textarea name="templatedescription" id="templatedescription" class="form-control" placeholder="Description"></textarea>
