...
<div class="padding60 overflow block">
    ...
    <div class="grid_12 omega">
        <form name="brand-name" id="settingsform" method="post" action="/settings/brands/add">
            <div class="label">How do you refer to this brand internally?</div>
            <input  type="text" class="textbox attach-validation inp no-margin-bottom" name="brand_name" errname="Brand Name" required="true" id="BrandName" placeholder="Enter your brand name">
            <div class="spacer-30"></div>


            <div class="label">How do you want it displayed to your clients?</div>
            <input  type="text" class="textbox attach-validation inp no-margin-bottom" name="company_name" errname="Company Name" required="true" id="CompanyName" placeholder="Company Name">

            <div class="spacer-30"></div>

            <div class="label">What language do you want your clients to see?</div>
            <select  name="language" errname="Language" id="LanguageID" class="textbox inp no-margin-bottom" required="true">
